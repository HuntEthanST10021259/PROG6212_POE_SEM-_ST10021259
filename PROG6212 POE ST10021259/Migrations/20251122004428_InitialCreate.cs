...
namespace PROG6212_POE_ST10021259.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportingDocument = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DateSubmitted = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Pending"),
                    CoordinatorApprovedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CoordinatorApprovedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ManagerApprovedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ManagerApprovedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
